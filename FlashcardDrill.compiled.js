...
export default function FlashcardDrillApp() {
    ...
    function handleOptionClick(idx) {
        ...
        if (opt.correct) {
            ...
            if (firstAttempt) {
                // First-try correct: this card won't reappear in any later review round this
                // session, so its fate is sealed right now — save it immediately instead of
                // waiting for the whole session to finish.
                const id = cycleOrder[cardPos];
