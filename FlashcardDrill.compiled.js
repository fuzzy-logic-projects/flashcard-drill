    ...
    if (!loaded) {
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("div", { className: "flex gap-2" },
                ...
                React.createElement("button", { onClick: () => { setNoteImportTitle(''); setNoteImportBody(''); setNoteImportContentType('markdown'); setView('noteImport'); }, style: { borderColor: COLORS.accent, color: COLORS.accent, ...fontStyle }, className: "rounded-lg border-2 px-3 py-2 text-xs font-bold flex items-center gap-1" },
                    React.createElement(Upload, { size: 14 }),
                    " Paste"),
                React.createElement("button", { onClick: () => noteFileInputRef.current && noteFileInputRef.current.click(), style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "rounded-lg px-3 py-2 text-white text-xs font-bold flex items-center gap-1" },
        ...
        content = readingNote ? (React.createElement("div", { className: "flex flex-col gap-4" },
            ...
            React.createElement("div", { className: "rounded-2xl py-6 px-5 -mx-5", style: { backgroundColor: COLORS.card } },
                ...
                readingNote.contentType === 'html' ? (React.createElement("iframe", { title: readingNote.title, srcDoc: readingNote.body, sandbox: "allow-scripts allow-forms", style: { width: '100%', height: '70vh', border: 'none', borderRadius: '10px', backgroundColor: '#fff' } })) : (React.createElement(NoteBody, { text: readingNote.body }))),
