    ...
    if (!loaded) {
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("div", { className: "flex flex-col gap-3 lg:grid lg:grid-cols-2 lg:gap-4 lg:mt-2" },
                React.createElement("button", { onClick: () => setView('deck'), className: "w-full rounded-2xl border-2 p-6 flex flex-col items-center gap-1 lg:p-10 lg:transition-transform lg:hover:-translate-y-0.5", style: { borderColor: COLORS.cardsAccent, backgroundColor: COLORS.cardsAccentBg } },
                    React.createElement(Layers, { size: 22, style: { color: COLORS.cardsAccent } }),
                    React.createElement("span", { style: { ...fontStyle, color: COLORS.cardsAccent }, className: "text-lg font-bold" }, "Cards"),
                    React.createElement("span", { style: { ...monoStyle, color: COLORS.cardsAccent }, className: "text-xs" },
                        ...
                        " card",
                        deckCardCount !== 1 ? 's' : '')),
                React.createElement("button", { onClick: () => setView('notes'), className: "w-full rounded-2xl border-2 p-6 flex flex-col items-center gap-1 lg:p-10 lg:transition-transform lg:hover:-translate-y-0.5", style: { borderColor: COLORS.notesAccent, backgroundColor: COLORS.notesAccentBg } },
                    React.createElement(BookOpen, { size: 22, style: { color: COLORS.notesAccent } }),
                    React.createElement("span", { style: { ...fontStyle, color: COLORS.notesAccent }, className: "text-lg font-bold" }, "Notes"),
