...
export default function FlashcardDrillApp() {
    ...
    return (React.createElement("div", { style: { backgroundColor: COLORS.rule }, className: "w-full min-h-screen flex justify-center md:items-start md:py-10 lg:justify-start lg:items-stretch lg:py-0" },
        ...
        .note-markdown table {
          ...
          max-width: 100%;
          min-width: max-content;   /* lets column widths follow real content
                                        needs (up to each cell's max-width) instead
                                        of shrinking to fit the container; forces
                                        overflow only when content genuinely needs
                                        the room */
