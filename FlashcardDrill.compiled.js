...
export default function FlashcardDrillApp() {
    ...
    if (!loaded) {
        ...
        if (flipCard) {
            ...
            content = (React.createElement(StampScreen, { tone: "navy", title: "DECK COMPLETE", subtitle: `${flipOrder.length} card${flipOrder.length !== 1 ? 's' : ''} reviewed · flip-through, not scheduled`, buttonLabel: "Back to Deck", onContinue: () => setView(returnView) }));
        }
    }
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-4" },
            React.createElement(BackHeader, { onBack: () => { setSheetFilterIds(null); setView(sheetFilterIds ? 'difficultyModes' : 'deck'); }, title: `${selectedDeck.name} · Sheet` }),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            React.createElement(BackHeader, { onBack: () => setView('deck'), title: `${selectedDeck.name} · By Difficulty` }),
        ...
        const tierIds = deckCards
            ...
            .map((c) => c.id);
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            React.createElement(BackHeader, { onBack: () => setView('difficultyTiers'), title: tierLabel }),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-4" },
            ...
            React.createElement("button", { onClick: () => {
                ...
                React.createElement("div", { className: "flex items-center gap-3" },
                    ...
                    React.createElement("div", null,
                        React.createElement("div", { style: fontStyle, className: "text-sm font-bold text-slate-800" }, "Edit Zone"),
            ...
            React.createElement("div", { className: "rounded-xl border-2 p-4 flex items-center justify-between", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } },
                React.createElement("span", { style: fontStyle, className: "text-sm font-bold" }, "Dark Mode"),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            React.createElement(BackHeader, { onBack: () => setView('settings'), title: "Edit Zone" }),
            ...
            React.createElement("div", { className: "flex flex-col gap-2" },
                categoryKeys.map((key) => {
                    ...
                    return (React.createElement("div", { key: key, className: "rounded-lg border p-3", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } }, renamingCategory === key ? (React.createElement("div", { className: "flex flex-col gap-2" },
                        ...
                        React.createElement("div", { className: "flex gap-2" },
                            React.createElement("button", { onClick: () => { renameCategory(key, renameCategoryDraft); setRenamingCategory(null); }, style: { backgroundColor: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg text-white text-xs font-bold py-2" }, "Save"),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            React.createElement(BackHeader, { onBack: () => { setEditZoneLevel('categories'); setEditZoneQuery(''); }, title: editZoneCategory }),
            editZoneNotice && (React.createElement("div", { className: "rounded-lg border-2 px-3 py-2", style: { borderColor: COLORS.mustard, backgroundColor: COLORS.mustardBg } },
                React.createElement("span", { style: { ...monoStyle, color: '#6B4E17' }, className: "text-xs" }, editZoneNotice))),
            React.createElement("div", { className: "relative" },
                React.createElement(Search, { size: 14, style: { color: COLORS.inkFaint }, className: "absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none" }),
            ...
            React.createElement("div", { className: "flex flex-col gap-2" },
                filteredDecks.map((d) => {
                    ...
                    return (React.createElement("div", { key: d.id, className: "rounded-lg border p-3", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } }, renamingDeckId === d.id ? (React.createElement("div", { className: "flex flex-col gap-2" },
                        ...
                        React.createElement("div", { className: "flex gap-2" },
                            React.createElement("button", { onClick: () => { renameDeck(d.id, renameDeckDraft); setRenamingDeckId(null); }, style: { backgroundColor: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg text-white text-xs font-bold py-2" }, "Save"),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            React.createElement(BackHeader, { onBack: () => { setEditZoneLevel('decks'); setEditZoneQuery(''); setEditingCardId(null); setConfirmDeleteCardId(null); }, title: zoneDeck ? zoneDeck.name : 'Cards' }),
            editZoneNotice && (React.createElement("div", { className: "rounded-lg border-2 px-3 py-2", style: { borderColor: COLORS.mustard, backgroundColor: COLORS.mustardBg } },
                React.createElement("span", { style: { ...monoStyle, color: '#6B4E17' }, className: "text-xs" }, editZoneNotice))),
            React.createElement("div", { className: "relative" },
                React.createElement(Search, { size: 14, style: { color: COLORS.inkFaint }, className: "absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none" }),
