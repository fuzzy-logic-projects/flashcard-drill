...
export default function FlashcardDrillApp() {
    ...
    if (!loaded) {
        ...
        const statTile = (label, value, color, caption) => (React.createElement("div", { key: label, className: "rounded-2xl border-2 px-5 py-4", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } },
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3 lg:gap-6" },
            ...
            React.createElement("button", { onClick: () => {
                ...
                }, disabled: totalDue === 0, style: { backgroundColor: totalDue > 0 ? COLORS.mustard : COLORS.disabledBg, ...fontStyle }, className: "w-full rounded-xl py-3 text-white font-bold tracking-wide focus:outline-none focus:ring-2 focus:ring-offset-2 lg:py-4 lg:text-base lg:rounded-2xl" },
                "Review All Due (",
                totalDue,
                ")"),
    ...
    return (React.createElement("div", { style: { backgroundColor: COLORS.rule }, className: "w-full min-h-screen flex justify-center md:items-start md:py-10 lg:justify-start lg:items-stretch lg:py-0" },
      ...
      `),
        sidebarEl,
        React.createElement("div", { style: { backgroundColor: COLORS.paper, borderColor: COLORS.rule }, className: "w-full max-w-sm md:max-w-lg lg:max-w-none min-h-screen md:min-h-0 md:rounded-2xl md:border-2 md:shadow-2xl lg:rounded-none lg:border-0 lg:shadow-none lg:flex-1 lg:flex lg:justify-center lg:overflow-y-auto lg:px-12 lg:py-12" },
            React.createElement("div", { className: `w-full max-w-sm mx-auto px-5 py-6 lg:mx-0 lg:w-full lg:px-0 lg:py-0 lg:self-start ${stageMaxWidth}` },
                React.createElement("div", { className: "flex items-center justify-between mb-5 lg:hidden" },
                ...
                React.createElement("div", { className: stagePanelClass, style: stagePanelStyle },
                    content || (React.createElement("div", { className: "flex flex-col gap-3" },
