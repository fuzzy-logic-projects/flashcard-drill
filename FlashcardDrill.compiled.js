...
// Warm dark theme in the spirit of Claude's own dark mode — a warm charcoal, not
// the cold blue-black of typical code-editor themes, to stay consistent with the
// app's serif/stamp aesthetic instead of clashing with it.
const COLORS_DARK = {
    paper: '#262624',
    card: '#33322E',
    ink: '#ECE9DE',
        ...
        if (phase === 'question' && currentCard) {
            ...
            content = (React.createElement("div", { className: "flex flex-col gap-4" },
                ...
                React.createElement("div", { className: "rounded-2xl border-2 px-5 py-6", style: { borderColor: COLORS.ink, backgroundColor: COLORS.card } },
                    ...
                    showHint && currentCard.hint && (React.createElement("div", { className: "mt-3 rounded-lg border border-dashed px-3 py-2 text-xs", style: { ...fontStyle, borderColor: COLORS.mustard, backgroundColor: COLORS.mustardBg, color: COLORS.mustardText, transform: 'rotate(-0.5deg)' } }, currentCard.hint))),
