...
export default function FlashcardDrillApp() {
    ...
    if (!loaded) {
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-4" },
            ...
            React.createElement("button", { onClick: createDeck, disabled: !newDeckName.trim(), style: { backgroundColor: newDeckName.trim() ? COLORS.accent : COLORS.disabledBg, ...fontStyle }, className: "w-full rounded-xl py-3 text-white font-bold tracking-wide disabled:opacity-60 transition-transform active:scale-[0.98]" }, "Create Deck")));
        // =====================================================================
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("button", { onClick: () => setView('importCardsChoice'), className: "w-full rounded-2xl border-2 p-6 flex flex-col items-center gap-1 shadow-sm transition-transform active:scale-[0.98] lg:p-10 lg:hover:-translate-y-0.5 lg:hover:shadow-lg", style: { borderColor: COLORS.cardsAccent, backgroundColor: COLORS.cardsAccentBg } },
            ...
            React.createElement("button", { onClick: () => setView('importNotesChoice'), className: "w-full rounded-2xl border-2 p-6 flex flex-col items-center gap-1 shadow-sm transition-transform active:scale-[0.98] lg:p-10 lg:hover:-translate-y-0.5 lg:hover:shadow-lg", style: { borderColor: COLORS.notesAccent, backgroundColor: COLORS.notesAccentBg } },
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("button", { onClick: () => setView('import'), className: "w-full rounded-2xl border-2 p-6 flex flex-col items-center gap-1 shadow-sm transition-transform active:scale-[0.98] lg:p-10 lg:hover:-translate-y-0.5 lg:hover:shadow-lg", style: { borderColor: COLORS.cardsAccent, backgroundColor: COLORS.cardsAccentBg } },
            ...
            React.createElement("button", { onClick: () => cardFileInputRef.current && cardFileInputRef.current.click(), className: "w-full rounded-2xl border-2 p-6 flex flex-col items-center gap-1 shadow-sm transition-transform active:scale-[0.98] lg:p-10 lg:hover:-translate-y-0.5 lg:hover:shadow-lg", style: { borderColor: COLORS.cardsAccent, backgroundColor: COLORS.cardsAccentBg } },
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("button", { onClick: () => { setNoteImportTitle(''); setNoteImportBody(''); setNoteImportContentType('markdown'); setView('noteImport'); }, className: "w-full rounded-2xl border-2 p-6 flex flex-col items-center gap-1 shadow-sm transition-transform active:scale-[0.98] lg:p-10 lg:hover:-translate-y-0.5 lg:hover:shadow-lg", style: { borderColor: COLORS.notesAccent, backgroundColor: COLORS.notesAccentBg } },
            ...
            React.createElement("button", { onClick: () => noteFileInputRef.current && noteFileInputRef.current.click(), className: "w-full rounded-2xl border-2 p-6 flex flex-col items-center gap-1 shadow-sm transition-transform active:scale-[0.98] lg:p-10 lg:hover:-translate-y-0.5 lg:hover:shadow-lg", style: { borderColor: COLORS.notesAccent, backgroundColor: COLORS.notesAccentBg } },
        ...
        if (decks.length === 0) {
            content = (React.createElement("div", { className: "flex flex-col gap-4" },
                ...
                React.createElement("button", { onClick: () => setView('newDeck'), style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "w-full rounded-xl py-3 text-white font-bold transition-transform active:scale-[0.98]" }, "Create Your First Deck")));
        }
        else {
            content = (React.createElement("div", { className: "flex flex-col gap-4" },
                ...
                React.createElement("button", { onClick: handleImportParse, disabled: !importText.trim(), style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "w-full rounded-xl border-2 py-2.5 font-bold disabled:opacity-40 transition-transform active:scale-[0.98]" }, "Parse"),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("div", { className: "flex flex-col gap-3 lg:grid lg:grid-cols-2 lg:gap-4 lg:mt-2" },
                React.createElement("button", { onClick: () => setView('deck'), className: "w-full rounded-2xl border-2 p-6 flex flex-col items-center gap-1 lg:p-10 lg:transition-transform lg:hover:-translate-y-0.5 shadow-sm transition-transform active:scale-[0.98] lg:hover:shadow-lg", style: { borderColor: COLORS.cardsAccent, backgroundColor: COLORS.cardsAccentBg } },
                    React.createElement(Layers, { size: 22, style: { color: COLORS.cardsAccent } }),
                    React.createElement("span", { style: { ...fontStyle, color: COLORS.cardsAccent }, className: "text-lg font-bold" }, "Cards"),
                    React.createElement("span", { style: { ...monoStyle, color: COLORS.cardsAccent }, className: "text-xs" },
                        ...
                        " card",
                        deckCardCount !== 1 ? 's' : '')),
                React.createElement("button", { onClick: () => setView('notes'), className: "w-full rounded-2xl border-2 p-6 flex flex-col items-center gap-1 lg:p-10 lg:transition-transform lg:hover:-translate-y-0.5 shadow-sm transition-transform active:scale-[0.98] lg:hover:shadow-lg", style: { borderColor: COLORS.notesAccent, backgroundColor: COLORS.notesAccentBg } },
                    React.createElement(BookOpen, { size: 22, style: { color: COLORS.notesAccent } }),
                    React.createElement("span", { style: { ...fontStyle, color: COLORS.notesAccent }, className: "text-lg font-bold" }, "Notes"),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-4" },
            ...
            React.createElement("div", { className: "flex flex-col gap-4 lg:grid lg:grid-cols-2 lg:gap-3" },
                React.createElement("button", { onClick: () => startFlip(deckCards.map((c) => c.id), 'deck', deckOrder), disabled: deckCards.length === 0, style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "w-full rounded-xl border-2 py-2.5 font-bold flex items-center justify-center gap-2 disabled:opacity-50 transition-transform active:scale-[0.98]" },
                    React.createElement(Layers, { size: 16 }),
                    " Flip Through"),
                React.createElement("button", { onClick: () => { setSheetFilterIds(null); setView('sheet'); }, disabled: deckCards.length === 0, style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "w-full rounded-xl border-2 py-2.5 font-bold flex items-center justify-center gap-2 disabled:opacity-50 transition-transform active:scale-[0.98]" },
                    React.createElement(FileText, { size: 16 }),
                    " View as Sheet")),
            React.createElement("button", { onClick: () => { setImportOrigin('deck'); setView('import'); }, style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "w-full rounded-xl border-2 py-2.5 font-bold flex items-center justify-center gap-2 transition-transform active:scale-[0.98]" },
            ...
            React.createElement("div", { className: "flex flex-col gap-4 lg:grid lg:grid-cols-2 lg:gap-3" },
                React.createElement("button", { onClick: () => { setRaceOrderChoice('random'); setView('practiceAllModes'); }, disabled: deckCards.length === 0, style: { backgroundColor: deckCards.length ? COLORS.accent : COLORS.disabledBg, ...fontStyle }, className: "w-full rounded-xl py-3 text-white font-bold tracking-wide disabled:opacity-60 transition-transform active:scale-[0.98]" }, "Practice All \u00B7 MCQ"),
                React.createElement("button", { onClick: () => { setRaceOrderChoice('random'); setSelectedDifficultyTier(null); setView('difficultyTiers'); }, disabled: deckCards.length === 0, style: { borderColor: COLORS.mustard, color: COLORS.mustard, ...fontStyle }, className: "w-full rounded-xl border-2 py-2.5 font-bold tracking-wide disabled:opacity-50 transition-transform active:scale-[0.98]" }, "Practice by Difficulty")),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("div", { className: "flex gap-2" },
                React.createElement("button", { onClick: () => { setImportOrigin('deck'); setNoteImportTitle(''); setNoteImportBody(''); setNoteImportContentType('markdown'); setView('noteImport'); }, style: { borderColor: COLORS.accent, color: COLORS.accent, ...fontStyle }, className: "flex-1 rounded-lg border-2 px-3 py-2 text-xs font-bold flex items-center justify-center gap-1 transition-transform active:scale-[0.98]" },
                    React.createElement(Upload, { size: 14 }),
                    " Paste"),
                React.createElement("button", { onClick: () => { setImportOrigin('deck'); noteFileInputRef.current && noteFileInputRef.current.click(); }, style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "flex-1 rounded-lg px-3 py-2 text-white text-xs font-bold flex items-center justify-center gap-1 transition-transform active:scale-[0.98]" },
                    React.createElement(FileText, { size: 14 }),
                    " From File")),
            React.createElement("div", { className: "flex flex-col gap-2" },
                sortedNotes.map((n) => {
                    const isDue = n.sr && n.sr.due <= todayStr2;
                    return (React.createElement("button", { key: n.id, onClick: () => { setSelectedNoteId(n.id); setView('noteRead'); }, className: "w-full text-left rounded-xl border-2 px-4 py-3 flex items-center justify-between gap-2 shadow-sm transition-transform active:scale-[0.98] lg:hover:shadow-md", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } },
        ...
        content = readingNote ? (React.createElement("div", { className: "flex flex-col gap-4" },
            ...
            React.createElement("div", { className: "flex gap-2" },
                React.createElement("button", { onClick: () => { rateNote(readingNote.id, 'hard'); setView('notes'); }, style: { backgroundColor: COLORS.red, ...fontStyle }, className: "flex-1 rounded-xl py-3 text-white text-sm font-bold transition-transform active:scale-[0.98]" }, "Hard"),
                React.createElement("button", { onClick: () => { rateNote(readingNote.id, 'moderate'); setView('notes'); }, style: { backgroundColor: COLORS.mustard, ...fontStyle }, className: "flex-1 rounded-xl py-3 text-white text-sm font-bold transition-transform active:scale-[0.98]" }, "Moderate"),
                React.createElement("button", { onClick: () => { rateNote(readingNote.id, 'easy'); setView('notes'); }, style: { backgroundColor: COLORS.green, ...fontStyle }, className: "flex-1 rounded-xl py-3 text-white text-sm font-bold transition-transform active:scale-[0.98]" }, "Easy")))) : null;
        // =====================================================================
        ...
        if (flipCard) {
            content = (React.createElement("div", { className: "flex flex-col gap-4" },
                React.createElement("div", { className: "flex justify-between items-center" },
                    React.createElement("button", { onClick: () => setView(returnView), style: { color: COLORS.inkFaint }, className: "p-1 rounded-lg hover:opacity-70 active:scale-90 transition" },
                ...
                React.createElement("button", { onClick: () => !flipShowAnswer && setFlipShowAnswer(true), className: "w-full rounded-2xl border-2 px-5 py-8 text-left focus:outline-none focus:ring-2 shadow-sm transition-transform active:scale-[0.99]", style: { borderColor: COLORS.ink, backgroundColor: COLORS.card } },
                ...
                flipShowAnswer && (React.createElement("button", { onClick: () => {
                    ...
                    }, style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "w-full rounded-xl py-3 text-white font-bold tracking-wide transition-transform active:scale-[0.98]" }, "Next Card"))));
        }
        else {
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-4" },
            ...
            sheetIds.length === 0 ? (React.createElement("p", { style: { ...fontStyle, color: COLORS.inkFaint }, className: "text-sm" }, "This deck is empty.")) : (React.createElement("div", { className: "flex flex-col gap-3" }, sheetIds.map((id, i) => {
                ...
                if (!c)
                    return null;
                return (React.createElement("div", { key: id, className: "rounded-xl border-2 px-4 py-3 shadow-sm", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } },
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            tiers.map((t) => (React.createElement("button", { key: t.key, onClick: () => { setSelectedDifficultyTier(t.key); setView('difficultyModes'); }, disabled: tierCards[t.key].length === 0, className: "w-full rounded-xl border-2 p-4 flex items-center justify-between disabled:opacity-40 shadow-sm transition-transform active:scale-[0.98]", style: { borderColor: t.color, backgroundColor: t.bg } },
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("button", { onClick: () => beginSession(tierIds, 'difficultyModes', sessionLabelText, false, raceOrderChoice), disabled: tierIds.length === 0, style: { backgroundColor: tierIds.length ? COLORS.accent : COLORS.disabledBg, ...fontStyle }, className: "w-full rounded-xl py-3 text-white font-bold tracking-wide disabled:opacity-60 transition-transform active:scale-[0.98]" }, "Normal Practice"),
            React.createElement("button", { onClick: () => goToRaceSetup(tierIds, sessionLabelText, 'difficultyModes', raceOrderChoice), disabled: tierIds.length === 0, style: { borderColor: COLORS.red, color: COLORS.red, ...fontStyle }, className: "w-full rounded-xl border-2 py-2.5 font-bold tracking-wide disabled:opacity-50 transition-transform active:scale-[0.98]" }, "Race")));
        // =====================================================================
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("button", { onClick: () => goToRaceSetup(poolIds, selectedDeck.name, 'practiceAllModes', raceOrderChoice), disabled: poolIds.length === 0, style: { borderColor: COLORS.red, color: COLORS.red, ...fontStyle }, className: "w-full rounded-xl border-2 py-2.5 font-bold tracking-wide disabled:opacity-50 transition-transform active:scale-[0.98]" }, "Race")));
    }
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("button", { onClick: confirmStartRace, disabled: racePendingPoolIds.length === 0, style: { backgroundColor: racePendingPoolIds.length ? COLORS.red : COLORS.disabledBg, ...fontStyle }, className: "w-full rounded-xl py-3 text-white font-bold tracking-wide disabled:opacity-60 mt-1 transition-transform active:scale-[0.98]" }, "Start Race")));
        // =====================================================================
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-4" },
            ...
            React.createElement("div", { className: "rounded-xl border-2 p-4 shadow-sm", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } },
            ...
            React.createElement("button", { onClick: () => { setDriveNotice(null); setView('backup'); }, className: "w-full text-left rounded-xl border-2 p-4 flex items-center justify-between gap-2 shadow-sm transition-transform active:scale-[0.98] hover:shadow-md", style: { borderColor: COLORS.ink, backgroundColor: COLORS.card } },
            ...
            React.createElement("button", { onClick: () => {
                    ...
                    setEditZoneNotice('');
                    setView('editZone');
                }, className: "w-full text-left rounded-xl border-2 p-4 flex items-center justify-between gap-2 shadow-sm transition-transform active:scale-[0.98] hover:shadow-md", style: { borderColor: COLORS.ink, backgroundColor: COLORS.card } },
                React.createElement("div", { className: "flex items-center gap-3" },
            ...
            React.createElement("div", { className: "rounded-xl border-2 p-4 flex items-center justify-between shadow-sm", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } },
                React.createElement("span", { style: { ...fontStyle, color: COLORS.ink }, className: "text-sm font-bold" }, "Dark Mode"),
                React.createElement("button", { onClick: () => persistDarkMode(!darkMode), style: { backgroundColor: darkMode ? COLORS.ink : COLORS.rule }, className: "w-12 h-7 rounded-full relative transition-colors active:scale-95" },
            ...
            React.createElement("div", { className: "rounded-xl border-2 p-4 shadow-sm", style: { borderColor: COLORS.red, backgroundColor: COLORS.card } },
                ...
                !confirmReset ? (React.createElement("button", { onClick: () => setConfirmReset(true), disabled: decks.length === 0, style: { color: COLORS.red, ...fontStyle }, className: "flex items-center gap-2 text-sm font-bold disabled:opacity-40" },
                    ...
                    React.createElement("div", { className: "flex gap-2" },
                        React.createElement("button", { onClick: resetEverything, style: { backgroundColor: COLORS.red, ...fontStyle }, className: "flex-1 rounded-lg text-white text-sm font-bold py-2 transition-transform active:scale-[0.98]" }, "Yes, Delete Everything"),
                        React.createElement("button", { onClick: () => setConfirmReset(false), style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-sm font-bold py-2 transition-transform active:scale-[0.98]" }, "Cancel")))))));
        // =====================================================================
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-4" },
            ...
            pendingRestore && (React.createElement("div", { className: "rounded-xl border-2 p-4 shadow-sm", style: { borderColor: COLORS.mustard, backgroundColor: COLORS.mustardBg } },
                ...
                React.createElement("p", { style: { ...monoStyle, color: COLORS.mustardText }, className: "text-xs mb-3 leading-relaxed" },
                    ...
                    ". It can't be undone."),
                React.createElement("div", { className: "flex gap-2" },
                    React.createElement("button", { onClick: applyPendingRestore, style: { backgroundColor: COLORS.mustard, ...fontStyle }, className: "flex-1 rounded-lg text-white text-sm font-bold py-2 transition-transform active:scale-[0.98]" }, "Restore"),
                    React.createElement("button", { onClick: () => setPendingRestore(null), style: { borderColor: COLORS.mustardText, color: COLORS.mustardText, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-sm font-bold py-2 transition-transform active:scale-[0.98]" }, "Cancel")))),
            signInSyncPrompt && (React.createElement("div", { className: "rounded-xl border-2 p-4 shadow-sm", style: { borderColor: COLORS.mustard, backgroundColor: COLORS.mustardBg } },
                ...
                React.createElement("div", { className: "flex gap-2" },
                    React.createElement("button", { onClick: applySignInMerge, style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "flex-1 rounded-lg text-white text-sm font-bold py-2 transition-transform active:scale-[0.98]" }, "Keep & Merge"),
                    React.createElement("button", { onClick: applySignInRewrite, style: { borderColor: COLORS.red, color: COLORS.red, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-sm font-bold py-2 transition-transform active:scale-[0.98]" }, "Rewrite")))),
            React.createElement("div", { className: "rounded-xl border-2 p-4 shadow-sm", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } },
                ...
                React.createElement("div", { className: "flex gap-2" },
                    React.createElement("button", { onClick: downloadLocalBackup, style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "flex-1 rounded-lg text-white text-sm font-bold py-2.5 flex items-center justify-center gap-2 transition-transform active:scale-[0.98]" },
                        React.createElement(Download, { size: 16 }),
                        " Download"),
                    React.createElement("button", { onClick: triggerRestoreFilePicker, style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-sm font-bold py-2.5 flex items-center justify-center gap-2 transition-transform active:scale-[0.98]" },
                ...
                !googleSignedIn ? (React.createElement("p", { style: { ...monoStyle, color: COLORS.inkFaint }, className: "text-xs" }, "Not signed in \u2014 use the \"Continue with Google\" button on the home screen to connect.")) : (React.createElement("div", { className: "flex flex-col gap-2" },
                    React.createElement("div", { className: "flex items-center justify-between" },
                        ...
                        React.createElement("button", { onClick: handleGoogleSignOut, style: { color: COLORS.inkFaint, ...fontStyle }, className: "text-xs flex items-center gap-1" },
                            ...
                            " Sign out")),
                    React.createElement("div", { className: "flex gap-2" },
                        React.createElement("button", { onClick: () => driveBackupNow(false), disabled: driveBusy, style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "flex-1 rounded-lg text-white text-sm font-bold py-2.5 flex items-center justify-center gap-2 disabled:opacity-50 transition-transform active:scale-[0.98]" },
                            React.createElement(RefreshCw, { size: 16 }),
                            " ",
                            driveBusy ? 'Working…' : 'Back Up Now'),
                        React.createElement("button", { onClick: driveRestoreNow, disabled: driveBusy, style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-sm font-bold py-2.5 flex items-center justify-center gap-2 disabled:opacity-50 transition-transform active:scale-[0.98]" },
                            React.createElement(HardDriveDownload, { size: 16 }),
                            " Restore")),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("div", { className: "flex flex-col gap-2" },
                categoryKeys.map((key) => {
                    ...
                    return (React.createElement("div", { key: key, className: "rounded-xl border-2 p-3 shadow-sm", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } }, renamingCategory === key ? (React.createElement("div", { className: "flex flex-col gap-2" },
                        ...
                        React.createElement("div", { className: "flex gap-2" },
                            React.createElement("button", { onClick: () => { renameCategory(key, renameCategoryDraft); setRenamingCategory(null); }, style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "flex-1 rounded-lg text-white text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Save"),
                            React.createElement("button", { onClick: () => setRenamingCategory(null), style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Cancel")))) : confirmDeleteCategory === key ? (React.createElement("div", { className: "flex flex-col gap-2" },
                        ...
                        React.createElement("div", { className: "flex gap-2" },
                            React.createElement("button", { onClick: () => { deleteCategory(key); setConfirmDeleteCategory(null); }, style: { backgroundColor: COLORS.red, ...fontStyle }, className: "flex-1 rounded-lg text-white text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Yes, Delete"),
                            React.createElement("button", { onClick: () => setConfirmDeleteCategory(null), style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Cancel")))) : (React.createElement("div", { className: "flex items-center justify-between gap-2" },
                        ...
                        React.createElement("button", { onClick: () => {
                            ...
                            }, style: { color: COLORS.mustard }, className: "p-1 shrink-0 rounded-lg hover:opacity-70 active:scale-90 transition" },
                            React.createElement(Brain, { size: 16 })),
                        !isUncategorized && (React.createElement(React.Fragment, null,
                            React.createElement("button", { onClick: () => { setRenamingCategory(key); setRenameCategoryDraft(key); }, style: { color: COLORS.ink }, className: "p-1 shrink-0 rounded-lg hover:opacity-70 active:scale-90 transition" },
                                React.createElement(Pencil, { size: 16 })),
                            React.createElement("button", { onClick: () => setConfirmDeleteCategory(key), style: { color: COLORS.red }, className: "p-1 shrink-0 rounded-lg hover:opacity-70 active:scale-90 transition" },
                                React.createElement(Trash2, { size: 16 }))))))));
                }),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("div", { className: "flex flex-col gap-2" },
                filteredDecks.map((d) => {
                    ...
                    return (React.createElement("div", { key: d.id, className: "rounded-xl border-2 p-3 shadow-sm", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } }, renamingDeckId === d.id ? (React.createElement("div", { className: "flex flex-col gap-2" },
                        ...
                        React.createElement("div", { className: "flex gap-2" },
                            React.createElement("button", { onClick: () => { renameDeck(d.id, renameDeckDraft); setRenamingDeckId(null); }, style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "flex-1 rounded-lg text-white text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Save"),
                            React.createElement("button", { onClick: () => setRenamingDeckId(null), style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Cancel")))) : confirmDeleteDeckId === d.id ? (React.createElement("div", { className: "flex flex-col gap-2" },
                        React.createElement("p", { style: { ...fontStyle, color: COLORS.ink }, className: "text-xs" },
                            "Delete \"",
                            d.name,
                            "\" and its ",
                        ...
                        React.createElement("div", { className: "flex gap-2" },
                            React.createElement("button", { onClick: () => { deleteDeck(d.id); setConfirmDeleteDeckId(null); }, style: { backgroundColor: COLORS.red, ...fontStyle }, className: "flex-1 rounded-lg text-white text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Yes, Delete"),
                            React.createElement("button", { onClick: () => setConfirmDeleteDeckId(null), style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Cancel")))) : (React.createElement("div", { className: "flex items-center justify-between gap-2" },
                        ...
                        React.createElement("button", { onClick: () => {
                            ...
                            React.createElement(Brain, { size: 16 })),
                        React.createElement("button", { onClick: () => { setEditZoneDeckId(d.id); setEditZoneNoteQuery(''); setEditZoneLevel('notes'); }, style: { color: COLORS.green }, className: "p-1 shrink-0 rounded-lg hover:opacity-70 active:scale-90 transition" },
                            React.createElement(BookOpen, { size: 16 })),
                        React.createElement("button", { onClick: () => { setRenamingDeckId(d.id); setRenameDeckDraft(d.name); }, style: { color: COLORS.ink }, className: "p-1 shrink-0 rounded-lg hover:opacity-70 active:scale-90 transition" },
                            React.createElement(Pencil, { size: 16 })),
                        React.createElement("button", { onClick: () => setConfirmDeleteDeckId(d.id), style: { color: COLORS.red }, className: "p-1 shrink-0 rounded-lg hover:opacity-70 active:scale-90 transition" },
                            React.createElement(Trash2, { size: 16 }))))));
                }),
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("div", { className: "rounded-xl border-2 p-4 flex flex-col gap-4 shadow-sm", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } },
                React.createElement("div", null,
                ...
                React.createElement("button", { onClick: () => {
                    ...
                    }, style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "w-full rounded-xl py-3 text-white font-bold tracking-wide transition-transform active:scale-[0.98]" },
                    "Save (",
                    resetNote,
                    ")"))));
        // =====================================================================
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("div", { className: "flex flex-col gap-2 max-h-[32rem] overflow-y-auto" },
                filteredNotes.map((n) => (React.createElement("div", { key: n.id, className: "rounded-xl border-2 p-3 shadow-sm", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } }, confirmDeleteNoteId === n.id ? (React.createElement("div", { className: "flex flex-col gap-2" },
                    React.createElement("p", { style: { ...fontStyle, color: COLORS.ink }, className: "text-xs" },
                        "Delete \"",
                        n.title,
                        "\" permanently?"),
                    React.createElement("div", { className: "flex gap-2" },
                        React.createElement("button", { onClick: () => deleteNote(n.id), style: { backgroundColor: COLORS.red, ...fontStyle }, className: "flex-1 rounded-lg text-white text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Yes, Delete"),
                        React.createElement("button", { onClick: () => setConfirmDeleteNoteId(null), style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Cancel")))) : (React.createElement("div", { className: "flex items-center justify-between gap-2" },
                    React.createElement("span", { style: { ...fontStyle, color: COLORS.ink }, className: "text-sm font-bold flex-1 truncate" }, n.title),
                    n.contentType === 'html' && (React.createElement("span", { style: { ...monoStyle, color: COLORS.ink, backgroundColor: COLORS.neutralBg }, className: "text-xs rounded-full px-2 py-0.5 shrink-0" }, "HTML")),
                    React.createElement("button", { onClick: () => { beginEditNote(n); setEditZoneLevel('noteEdit'); }, style: { color: COLORS.ink }, className: "p-1 shrink-0 rounded-lg hover:opacity-70 active:scale-90 transition" },
                        React.createElement(Pencil, { size: 14 })),
                    React.createElement("button", { onClick: () => setConfirmDeleteNoteId(n.id), style: { color: COLORS.red }, className: "p-1 shrink-0 rounded-lg hover:opacity-70 active:scale-90 transition" },
        ...
        content = (React.createElement("div", { className: "flex flex-col gap-3" },
            ...
            React.createElement("div", { className: "flex flex-col gap-3 max-h-[32rem] overflow-y-auto" },
                filteredCards.map((c, i) => (React.createElement("div", { key: c.id, className: "rounded-xl border-2 px-4 py-3 shadow-sm", style: { borderColor: COLORS.rule, backgroundColor: COLORS.card } }, editingCardId === c.id ? (React.createElement("div", { className: "flex flex-col gap-2" },
                    ...
                    React.createElement("div", { className: "flex gap-2" },
                        React.createElement("button", { onClick: saveEditCard, style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "flex-1 rounded-lg text-white text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Save"),
                        React.createElement("button", { onClick: cancelEditCard, style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Cancel")))) : confirmDeleteCardId === c.id ? (React.createElement("div", { className: "flex flex-col gap-2" },
                    React.createElement("p", { style: { ...fontStyle, color: COLORS.ink }, className: "text-xs" }, "Delete this card permanently?"),
                    React.createElement("div", { className: "flex gap-2" },
                        React.createElement("button", { onClick: () => deleteSingleCard(c.id), style: { backgroundColor: COLORS.red, ...fontStyle }, className: "flex-1 rounded-lg text-white text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Yes, Delete"),
                        React.createElement("button", { onClick: () => setConfirmDeleteCardId(null), style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "flex-1 rounded-lg border-2 text-xs font-bold py-2 transition-transform active:scale-[0.98]" }, "Cancel")))) : (React.createElement(React.Fragment, null,
                    React.createElement("div", { className: "flex items-start justify-between gap-2" },
                        ...
                        React.createElement("div", { className: "flex gap-1 shrink-0" },
                            React.createElement("button", { onClick: () => beginEditCard(c), style: { color: COLORS.ink }, className: "p-1 rounded-lg hover:opacity-70 active:scale-90 transition" },
                                React.createElement(Pencil, { size: 14 })),
                            React.createElement("button", { onClick: () => setConfirmDeleteCardId(c.id), style: { color: COLORS.red }, className: "p-1 rounded-lg hover:opacity-70 active:scale-90 transition" },
                                React.createElement(Trash2, { size: 14 })))),
                    React.createElement(MathText, { text: c.correctAnswer, style: { ...fontStyle, color: COLORS.green }, className: "text-sm font-bold mt-1 block" }),
                    c.hint && (React.createElement("div", { style: { ...fontStyle, color: COLORS.mustard }, className: "text-xs mt-1 italic" },
                        "Hint: ",
    ...
    const sidebarEl = (React.createElement("aside", { style: { backgroundColor: COLORS.card, borderColor: COLORS.rule }, className: "hidden lg:flex lg:flex-col lg:w-72 lg:shrink-0 lg:h-screen lg:sticky lg:top-0 lg:px-6 lg:py-8 lg:gap-6 lg:border-r-2 lg:overflow-y-auto" },
        ...
        React.createElement("nav", { className: "flex flex-col gap-1" },
            React.createElement("button", { onClick: goHome, style: { ...fontStyle, color: isHomeView ? '#fff' : COLORS.ink, backgroundColor: isHomeView ? COLORS.accent : 'transparent' }, className: "w-full text-left rounded-lg px-3 py-2.5 font-bold text-sm flex items-center gap-2.5 transition-transform hover:translate-x-0.5 active:scale-[0.98]" }, React.createElement(HomeIcon, { size: 16 }), "Home"),
            React.createElement("button", { onClick: () => setView('settings'), style: { ...fontStyle, color: isSettingsFamily ? '#fff' : COLORS.ink, backgroundColor: isSettingsFamily ? COLORS.accent : 'transparent' }, className: "w-full text-left rounded-lg px-3 py-2.5 font-bold text-sm flex items-center gap-2.5 transition-transform hover:translate-x-0.5 active:scale-[0.98]" }, React.createElement(SettingsIcon, { size: 16 }), "Settings"),
            React.createElement("button", { onClick: () => setView('newDeck'), style: { borderColor: COLORS.ink, color: COLORS.ink, ...fontStyle }, className: "w-full text-left rounded-lg px-3 py-2.5 font-bold text-sm flex items-center gap-2.5 border-2 mt-1 transition-transform hover:translate-x-0.5 active:scale-[0.98]" }, React.createElement(Plus, { size: 16 }), "New Deck")),
        ...
        React.createElement("div", { className: "flex items-center justify-between rounded-lg px-3 py-2 border-2", style: { borderColor: COLORS.rule } },
            ...
            React.createElement("button", { onClick: () => persistDarkMode(!darkMode), style: { backgroundColor: darkMode ? COLORS.ink : COLORS.rule }, className: "w-11 h-6 rounded-full relative transition-colors shrink-0 active:scale-95" }, React.createElement("span", { className: "absolute top-0.5 w-5 h-5 rounded-full bg-white transition-all", style: { left: darkMode ? '20px' : '2px' } }))),
    ...
    const fallbackEl = (React.createElement("div", { className: "flex flex-col gap-3" },
        ...
        React.createElement("button", { onClick: () => setView('home'), style: { backgroundColor: COLORS.accent, ...fontStyle }, className: "w-full rounded-xl py-3 text-white font-bold transition-transform active:scale-[0.98]" }, "Back to Home")));
...
function BackHeader({ onBack, title, colors: COLORS }) {
    return (React.createElement("div", { className: "flex items-center gap-2 mb-1" },
        React.createElement("button", { onClick: onBack, style: { color: COLORS.inkFaint }, className: "p-1 rounded-lg hover:opacity-70 active:scale-90 transition" },
            React.createElement(ChevronLeft, { size: 20 })),
